        ...
        <div className="dropdown">
            ...
            <ul className="dropdown-menu" aria-labelledby="dropdownMenu1">
                ...
                <li onClick={()=>this.onClick("status",1)}>
                    <a role="button" className={(this.props.sortBy === "status" && this.props.sortValue === 1) ? "sort_selected" : ""}>Activated Status</a>
                </li>
                <li onClick={()=>this.onClick("status",-1)}>
                    <a role="button" className={(this.props.sortBy === "status" && this.props.sortValue === -1) ? "sort_selected" : ""}>Hidden Status</a>
                </li>
            </ul>
        </div>
    </div>
